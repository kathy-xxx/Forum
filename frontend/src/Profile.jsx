...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8081/user/${user.user_id}/communities`)
      .then((res) => setCommunities(res.data))
      .catch((err) => console.error("Error fetching communities:", err));

    axios
      .get(`http://localhost:8081/user/${user.user_id}/posts`)
      .then((res) => setPosts(res.data))
      .catch((err) => console.error("Error fetching posts:", err));

    axios
      .get(`http://localhost:8081/user/${user.user_id}/activity`)
  ...
  const handleSave = (e) => {
    e.preventDefault();
    axios
      .put(`http://localhost:8081/user/${user.user_id}`, editData)
      .then((res) => {
      ...
      {isEditing ? (
        ...
        <>
          <div className="card p-4 mb-4">
            ...
            <p>
              <strong>Posts:</strong> {userActivity.post_count}
            </p>
            <p>
              <strong>Comments:</strong> {userActivity.comment_count}
            </p>
